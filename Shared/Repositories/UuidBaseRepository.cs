...
{
    public abstract class UuidBaseRepository<DbContextType, EntityType, SearchParametersType> : IUuidBaseRepository<EntityType, SearchParametersType>
        ...
        where SearchParametersType : ISearchParameters
    {
        ...
        public UuidBaseRepository(DbContextType context)
        {
        ...
        public virtual async Task<IEnumerable<EntityType>> GetMultiple(IEnumerable<Guid> ids, ShapingWithOrderingParameters parameters)
        {
            if (ids == null)
        ...
        public virtual async Task<PagedList<EntityType>> GetMultiple(SearchParametersType parameters)
        {
            IQueryable<EntityType> collection = _dbSet as IQueryable<EntityType>;
