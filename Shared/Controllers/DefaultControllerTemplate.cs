...
namespace Shared.Controllers
{
    ...
    [ApiController]
    public abstract class DefaultControllerTemplate<EntityType, ViewType, CreateType, PatchType, SearchParametersType> : BasicControllerTemplate
        where EntityType : UuidBaseEntity
        where PatchType : class
        where SearchParametersType : SearchParameters
    {
        protected readonly IUuidBaseRepository<EntityType, SearchParametersType> _repository;
        protected readonly IMapper _mapper;

        public DefaultControllerTemplate(
            IMapper mapper,
            IUuidBaseRepository<EntityType, SearchParametersType> repository
        )
        {
            _mapper = mapper;
        ...
        )
        {
            ...
            var entities = await _repository.GetMultiple(ids, parameters);
