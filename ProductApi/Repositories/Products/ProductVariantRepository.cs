...
namespace ProductApi.Repositories.Products
{
    public class ProductVariantRepository
        : Shared.Repositories.UuidBaseRepository<MainDbContext, ProductVariant, SearchParameters>
        , IProductVariantRepository<ProductVariant, SearchParameters>
    {
        public ProductVariantRepository(MainDbContext context) : base(context) { }

        public async override Task<PagedList<ProductVariant>> GetMultiple(SearchParameters parameters)
        {
