...
namespace AuthApi.Services.Authentication
{
    public class JwtService : IJwtService
    {
        ...
        public bool ValidateTokenPairForRefresh(AuthenticationTokens tokens, string ipAddress)
        {
            ...
            var accessDeviceId = accessSecurityToken.Claims.Where(c => c.Type == DEVICE_ID).FirstOrDefault();
            var refreshDeviceId = refreshSecurityToken.Claims.Where(c => c.Type == DEVICE_ID).FirstOrDefault();
        ...
        )
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new(DEVICE_ID, TextService.GetHash(ipAddress))
            };
