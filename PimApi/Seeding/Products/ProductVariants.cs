        ...
        public static async Task Seed(WebApplication app)
        {
            using (var scope = app.Services.CreateScope())
            {
                ...
                else
                {
                    ...
                    {
                        productCount++;
                        bool isWaterproof = random.Next(0, 1) == 1;
                        bool isNew = random.Next(0, 1) == 1;
                        bool isSale = random.Next(0, 1) == 1;
                        ...
                        Console.Write($"Seeding product variants for product: {productCount}");
